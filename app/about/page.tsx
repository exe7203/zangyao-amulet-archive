...
export const metadata: Metadata = infoPageMetadata(
  "關於泰聚達",
  "認識泰聚達如何記錄泰國佛牌與聖物的來源、年代、材質與保存資訊。",
  "about/",
);

export default function AboutPage() {
  return <InfoPage eyebrow="ABOUT TAIJUDA" title="關於泰聚達" intro="我們希望收藏的理由能被說清楚：已知的留下證據，未知的誠實標示。">
    <section><h2>來源可讀，收藏可久</h2><p>泰聚達以藏品履歷為核心，逐件整理名稱、取得地區、寺院或法會說法、佛曆與西元年份、材質、尺寸、保存狀態及實拍日期。履歷是現有資訊的紀錄，不等同真偽保證；仍待確認的內容會明確標示。</p></section>
