...
export default function ShippingPage() {
  return <InfoPage eyebrow="DELIVERY & PAYMENT" title="配送與付款" intro="目前採先建立保留單、再由店家確認的方式，不會在網站直接收取款項。" path="service/shipping/">
    ...
    <section><p className={infoStyles.note}>網站不會要求輸入信用卡號或網路銀行密碼。正式金流尚未串接前，付款資訊僅應透過店家確認的管道取得。</p></section>
  </InfoPage>;
}
