...
export const products: Product[] = [
  ...
  { id: 2, slug: "pidta-black-powder", name: "必打佛・黑色粉質版", shortName: "必打佛", category: "佛牌", origin: "北欖府", temple: "寺院來源待逐件覆核", buddhistYear: "佛曆 2565", westernYear: "西元 2022", material: "混合聖粉", dimensions: "2.8 × 2.2 cm", price: 4280, badge: "一物一拍", tone: "charcoal", shape: "oval", theme: "守護與安心", purchaseLimit: 1 },
  ...
  { id: 7, slug: "nang-kwak-temple-edition", name: "招財女神・寺院紀念版", shortName: "招財女神", category: "佛牌", origin: "大城府", temple: "寺院來源待逐件覆核", buddhistYear: "佛曆 2565", westernYear: "西元 2022", material: "粉質", dimensions: "3.7 × 2.3 cm", price: 3280, badge: "一物一拍", tone: "ivory", shape: "arch", theme: "財運與商務", purchaseLimit: 1 },
